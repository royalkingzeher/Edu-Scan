...
await mongoose.connect("mongodb+srv://raghavmittal26113:BJihQ5ogfkMlpy3C@cluster0.uwfzaxf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0").then(() =>{console.log("connected to database successfully")}).catch((error)=> {console.log("error in connecting to database" , error)})
